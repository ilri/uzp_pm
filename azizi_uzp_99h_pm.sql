...
--
-- Host: localhost
-- Generation Time: Sep 04, 2015 at 08:47 AM
...
CREATE TABLE IF NOT EXISTS `postmortem` (
  ...
  `bsmear_1_box` varchar(50) DEFAULT NULL,
  `bsmear_1_pos` int(11) DEFAULT NULL,
  `bsmear_2` varchar(50) DEFAULT NULL,
  `bsmear_2_box` varchar(50) DEFAULT NULL,
  `bsmear_2_pos` int(11) DEFAULT NULL,
  ...
  `bcs` decimal(10,2) DEFAULT NULL,
  `body_length` decimal(10,2) DEFAULT NULL,
  `ear_length` decimal(10,2) DEFAULT NULL,
  `tragus_length` decimal(10,2) DEFAULT NULL,
  `forearm_length` decimal(10,2) DEFAULT NULL,
  `tibia_length` decimal(10,2) DEFAULT NULL,
  `hfoot_length` decimal(10,2) DEFAULT NULL,
  `tail_length` decimal(10,2) DEFAULT NULL,
  ...
  `pectoral_1_bc` varchar(50) DEFAULT NULL,
  `pectoral_2_bc` varchar(50) DEFAULT NULL,
  ...
  `brain_weight` decimal(10,2) DEFAULT NULL,
  ...
  `parts_pot_bc` varchar(50) DEFAULT NULL,
  ...
  `integument_img` varchar(50) DEFAULT NULL,
  `pectoral_img` varchar(50) DEFAULT NULL,
  `ptagium_img` varchar(50) DEFAULT NULL,
  `saliva_img` varchar(50) DEFAULT NULL,
  `cavity_img` varchar(50) DEFAULT NULL,
  `diaphgram_img` varchar(50) DEFAULT NULL,
  `liver_img` varchar(50) DEFAULT NULL,
  `spleen_img` varchar(50) DEFAULT NULL,
  `kidney_img` varchar(50) DEFAULT NULL,
  `adrenal_img` varchar(50) DEFAULT NULL,
  `heart_img` varchar(50) DEFAULT NULL,
  `lung_img` varchar(50) DEFAULT NULL,
  `pluck_img` varchar(50) DEFAULT NULL,
  `brain_img` varchar(50) DEFAULT NULL,
  `urogen_img` varchar(50) DEFAULT NULL,
  `stomach_img` varchar(50) DEFAULT NULL,
  `ileum_img` varchar(50) DEFAULT NULL,
  `smallint_img` varchar(50) DEFAULT NULL,
  `largeint_img` varchar(50) DEFAULT NULL
