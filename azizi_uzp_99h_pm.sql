...
--
-- Host: localhost
-- Generation Time: Sep 02, 2015 at 07:27 AM
...
CREATE TABLE IF NOT EXISTS `postmortem` (
  ...
  `integument_les` varchar(50) DEFAULT NULL,
  `integument_bc` varchar(50) DEFAULT NULL,
  `pectoral_les` varchar(50) DEFAULT NULL,
  `pectoral_mc` varchar(50) DEFAULT NULL,
  `ptagium_les` varchar(50) DEFAULT NULL,
  `ptagium_bc` varchar(50) DEFAULT NULL,
  `saliva_les` varchar(50) DEFAULT NULL,
  `saliva_1_bc` varchar(50) DEFAULT NULL,
  `saliva_2_bc` varchar(50) DEFAULT NULL,
  `saliva_3_bc` varchar(50) DEFAULT NULL,
  `cavity_les` varchar(50) DEFAULT NULL,
  `diaphgram_les` varchar(50) DEFAULT NULL,
  `diaphgram_bc` varchar(50) DEFAULT NULL,
  `liver_les` varchar(50) DEFAULT NULL,
  ...
  `spleen_les` varchar(50) DEFAULT NULL,
  ...
  `kidney_les` varchar(50) DEFAULT NULL,
  ...
  `pluck_les` varchar(50) DEFAULT NULL,
  ...
  `brain_les` varchar(50) DEFAULT NULL,
  ...
  `smallint_les` varchar(50) DEFAULT NULL,
  `smallint_bc` varchar(50) DEFAULT NULL,
  `largeint_les` varchar(50) DEFAULT NULL,
